...
const Contact = () => {
    useDocTitle('Raayyaag - Send us a message')
            ...
            <div className="flex justify-center items-center mt-8 w-full bg-white py-12 lg:py-24 bg-gray-200">
                ...
                <form onSubmit={sendEmail}>
                    ...
                    <div className="w-full bg-white p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
                        <div className="flex">
                            <h1 className="font-bold text-center lg:text-left text-teal-800 uppercase text-4xl">Send us a message</h1>
                        </div>
                        ...
                        <div
                            className="w-full  lg:-mt-96 lg:w-2/6 px-8 py-6 ml-auto bg-teal-500 rounded-2xl">
                    ...
                    <div className="flex my-4 w-2/3 lg:w-1/2">
                        ...
                        <p className="text-white-800">+91 9087459062</p>
                            ...
                            <div className='mt-5'>
                                ...
                                <p className="text-white-800">contact@raayyaag.com</p>
                            </div>
